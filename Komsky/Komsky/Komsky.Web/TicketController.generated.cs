...
namespace Komsky.Web.Controllers
{
    public partial class TicketController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Views/Ticket/Edit.cshtml";
            public readonly string Index = "~/Views/Ticket/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TicketController : Komsky.Web.Controllers.TicketController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Komsky.Web.Models.TicketViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Komsky.Web.Models.TicketViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Komsky.Web.Models.TicketViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Komsky.Web.Models.TicketViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Komsky.Web.Models.TicketViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(Komsky.Web.Models.TicketViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
