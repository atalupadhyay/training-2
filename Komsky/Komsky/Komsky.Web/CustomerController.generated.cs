...
namespace Komsky.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CustomerController : Komsky.Web.Controllers.CustomerController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Komsky.Web.Models.CustomerViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Komsky.Web.Models.CustomerViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Komsky.Web.Models.CustomerViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Komsky.Web.Models.CustomerViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
